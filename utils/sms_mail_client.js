...
//         var msgStr = `Hello ${name},here is your task list from olaf\n`;
//         var taskStr = "msg from olaf";
...
function sendMessageCustomer(userInfo){
    console.log("Details to Twilio");
}

module.exports=sendMessageCustomer;
